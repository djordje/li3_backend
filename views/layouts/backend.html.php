...
<head>
	...
	<?php echo $this->html->style('/assets/backend/google-code-prettify/prettify'); ?>
	<?php echo $this->html->script('/assets/backend/google-code-prettify/prettify'); ?>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="nav-collapse collapse">
					...
					<ul class="nav">
						<?php echo $this->_render('element', 'navbar_backend'); ?>
					</ul>
				</div>
				<div class="nav-collapse collapse">
